# -*- coding: utf-8 -*-
"""
The scripts reads the results from SPECFEM2D acoustic-elastic modeling software.
The user can select the results as recorded by the receiver stations for the vertical or
horizontal component using a pop-up file dialog. 
